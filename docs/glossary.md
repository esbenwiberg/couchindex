...
- **Title**: A movie or series in the catalogue.
- **Provider**: A streaming service.
- **Offer**: Regional availability of a title from a provider.
- **Launch target**: A deep link, intent or web destination used to open content.
...
- **Browse row**: A horizontally scrolling collection organized around one useful rule.
